...
parser.add_argument('--dataset', metavar='PATH', type=str, default="data",required=True, help='Input file, directory, or glob pattern (utf-8 text, or preencoded .npz files).')
